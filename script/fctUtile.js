...
var drawTable = {
    ...
    exportHTML: (name, source) => {
        var header = "<html xmlns:o='urn:schemas-microsoft-com:office:office' "+
             ...
             <style> body {background-color: powderblue; font-family: sans-serif;} \
             table, th, td { border: 1px solid rgb(235, 235, 235); border-collapse: collapse; padding: 2px;} </style> </head><body>";
